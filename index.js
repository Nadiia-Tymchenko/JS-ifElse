...
// завдання 3
const discount_3_percent = 3;
const discount_5_percent = 5;
...
if (purchaseAmount > 800) {
  finalAmount = purchaseAmount * (1 - discount_5_percent / 100);
  alert("Сума покупки зі знижкою 5% : " + finalAmount + " грн");
} else if (purchaseAmount > 500) {
  finalAmount = purchaseAmount * (1 - discount_3_percent / 100);
